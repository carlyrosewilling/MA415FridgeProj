...
author: "Carly Rose Willing in collaboration with Brian Clare, Elise Roche, Melody Schaff, and Joe Kass"
...
ggplot(data=fridge, mapping=aes(x = DIVISION, y = NUMFRIG, color = as.factor(DIVISION))) + 
  ...
  labs(title="Number of Refrigerators vs. Geographic Census Division", y="Number of Refrigerators", x="Geographic Division") +
