...
```{r warning=FALSE}
ggplot(data=fridge, mapping=aes(x = DIVISION, y = NUMFRIG, color = as.factor(DIVISION))) + geom_jitter() + labs(title="Number of Refrigerators Per Division", y="Number of Refrigerators", x="Geographic Division") + scale_colour_hue(name="Geographic Region", labels=c("New England", "MidAtlantic", "ENC", "WNC", "SouthAtlantic", "ESC","WSC","MNo","MSo","Pacific")) + theme(axis.text.x = element_text(angle = 70, hjust = 1))
...
```{r warning = FALSE}
ggplot(data=fridge, mapping=aes(x=DIVISION, y=AGERFRI1, colour = DIVISION, show.legend = FALSE)) + geom_jitter() + labs(title="Age of Most Used Refrigerator vs. Geographic Region", x="Geographic Region", y="Age of Most Used Refrigerator") + theme(axis.text.x = element_text(angle = 70, hjust = 1))
