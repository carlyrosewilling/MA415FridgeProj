...
ggplot(data=fridge, mapping=aes(x = DIVISION, y = NUMFRIG, color = as.factor(DIVISION))) + 
  geom_jitter() + labs(title="Number of Refrigerators vs. Geographic Census Division", y="Number of Refrigerators", x="Geographic Division") +
...
```{r warning = FALSE}
ggplot(data=fridge, mapping=aes(x=DIVISION, y=AGERFRI1, color=as.factor(DIVISION))) + geom_jitter() + labs(title="Age of Most Used Refrigerator vs. Geographic Region", x="Geographic Region", y="Age of Most Used Refrigerator") +
