...
The only significant increase in refrigerator consumption come from the group that cooks a few meals a day, which also tend to have smaller than average refrigerators. Because this group is the most populous, we can assume that the average consumer would be willing to purchase an additional small refrigerator given conducive advertising.
